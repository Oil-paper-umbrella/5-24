...
let getUser = async function () {
  return await axios
  .get(
    "/rest/CrudServlet/getJsonAllUserAndRole"
  )
}
...
let delUser = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/delUserById",body
  )
}
...
let updateUser = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/updateUser",body
  )
}
...
let addRolesToUser = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/setUserRoles",body
  )
}
...
let updateRoleToUser = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/updateUserRoles",body
  )
}
...
let findUserRoleInfo = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/getJSonOneUserAndRole?token",body
  )
}
