...
let getAllRole = async function () {
  return await axios
  .get(
    "/rest/CrudServlet/getJsonAllRoleAndAut"
  )
}
...
let getAllPower = async function () {
  return await axios
  .get(
    "/rest/CrudServlet/getAllAuthoritys"
  )
}
...
let updateRole = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/updateRole",body
  )
}
...
let getRoleOfPower = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/getOneRoleAndAut",body
  )
}
...
let setPower = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/setRoleAuthos",body
  )
}
...
let updateRoleOfPrower = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/updateRoleAuthos",body
  )
}
...
let delRole = async function (body) {
  return await axios
  .post(
    "/rest/CrudServlet/delRoleById",body
  )
}
